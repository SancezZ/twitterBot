...
public class Start {
	 ...
	 * 
	 * @param args[0]= consumerKey args[1]= consumerSecret args[2]= accessToken
	...
	public static void main(String[] args) {
		...
		if (!(args.length >= 4)) {
			System.out
					.println("Bitte geben Sie alle TwitterApp-Schluessel mit!");
		}
	...
	private static void showMenue() {
		System.out
				.println("-----------------------------------------------------------------");
		System.out
				.println("-----------Drücke 1 zum Folgen eines Users-----------------------");
		System.out
				.println("-----------Drücke 2 zum erneuten anzeigen des Menues. -----------");
		System.out
				.println("-----------Drücke 3 zum Schließen des Programms.-----------------");
		System.out
				.println("-----------Die Auswahl mit Enter bestätigen.---------------------");
		System.out
				.println("-----------------------------------------------------------------");
	}
		...
		while (true) {
			try {
				...
				switch (auswahl) {
					case 1 :
						System.out
								.println("Geben Sie den Names des zu Folgenden Users ein(@Username)");
